...
router.get("/categories/:projectId/assign", loggedInMiddleware, requireRole("admin"), showAssignCategoriesForm);
router.post("/categories/:projectId/assign", loggedInMiddleware, requireRole("admin"), processAssignCategoriesForm);
